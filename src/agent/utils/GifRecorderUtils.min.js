...
(LZWEncoder = function() {
    var c = {},
        ...
        yt = (c.compress = function yt(n, i) {
            var w, c, nt, l, rt, g, k;
            for (
                v = n, h = !1, t = v, o = b(t), f = 1 << (n - 1), p = f + 1, s = f + 2, r = 0, l = d(), k = 0, w = a;
                w < 65536;
                w *= 2
            )
                ++k;
    ...
    (NeuQuant = function() {
        var c = {},
            ...
            ht = (c.NeuQuant = function ht(u, f, e) {
                var c, l;
                for (w = u, i = f, h = e, n = new Array(t), c = 0; c < t; c++)
                    (n[c] = new Array(4)),
                        (l = n[c]),
                        (l[0] = l[1] = l[2] = (c << (r + 8)) / t),
                        (s[c] = y / t),
            ...
            ct = function() {
                ...
                for (o = 0, h = 0, e = 0; e < t; e++) {
                    for (u = n[e], c = e, s = u[1], i = e + 1; i < t; i++)
                        (r = n[i]), r[1] < s && ((c = i), (s = r[1]));
                    if (
                        ((r = n[c]),
                        e != c &&
                            ((i = r[0]),
            ...
            vt = function() {
                ...
                for (
                    ...
                    v[t] = s * (((n * n - t * t) * d) / (n * n));
                for (
                    o = i < g ? 3 : i % tt != 0 ? 3 * tt : i % nt != 0 ? 3 * nt : i % rt != 0 ? 3 * rt : 3 * it, t = 0;
                    t < ut;
                    ...
                    if (
                        ...
                        for (s -= s / et, c -= c / kt, n = c >> l, n <= 1 && (n = 0), u = 0; u < n; u++)
                            v[u] = s * (((n * n - u * u) * d) / (n * n));
            },
            ri = (c.map = function(i, r, u) {
                var c, l, e, o, h, s, a;
                for (h = 1e3, a = -1, c = f[r], l = c - 1; c < t || l >= 0; )
                    c < t &&
                        ((s = n[c]),
                        (e = s[1] - r),
                        e >= h
                            ...
                            : (c++,
                              ...
                              o < 0 && (o = -o),
                              (e += o),
                              e < h && ((o = s[2] - u), o < 0 && (o = -o), (e += o), e < h && ((h = e), (a = s[3]))))),
                        l >= 0 &&
                            ((s = n[l]),
                            (e = r - s[1]),
                            e >= h
                                ...
                                : (l--,
                                  ...
                                  (e += o),
                                  e < h &&
                                      ((o = s[2] - u), o < 0 && (o = -o), (e += o), e < h && ((h = e), (a = s[3])))));
                return a;
            }),
            ...
            lt = function(i, r, f, e, o) {
                var a, y, l, c, h, p, s;
                for (
                    l = r - i, l < -1 && (l = -1), c = r + i, c > t && (c = t), a = r + 1, y = r - 1, p = 1;
                    a < c || y > l;
            ...
            yt = function(i, u, f) {
                ...
                for (v = 2147483647, w = v, l = -1, k = l, h = 0; h < t; h++)
                    (y = n[h]),
                        (c = y[0] - i),
                        c < 0 && (c = -c),
                        (e = y[1] - u),
        ...
        var t = {},
            ...
            kt = (t.addFrame = function(t, i) {
                ...
                try {
                    i
                        ? (a = t)
                        : ((a = t.getImageData(0, 0, t.canvas.width, t.canvas.height).data),
                          ft || et(t.canvas.width, t.canvas.height)),
                        ct(),
                        ht(),
                        e && (vt(), tt(), k >= 0 && lt()),
                        st(),
            ...
            ht = function() {
                var e = i.length,
                    ...
                    t,
                    u;
                for (l = [], f = new NeuQuant(i, e, it), r = f.process(), n = 0, t = 0; t < o; t++)
                    (u = f.map(i[n++] & 255, i[n++] & 255, i[n++] & 255)), (ut[u] = !0), (l[t] = u);
            ...
            ct = function() {
                ...
                for (i = [], f = a, u = 0, t = 0; t < h; t++)
                    for (r = 0; r < e; r++)
                        (n = t * e * 4 + r * 4), (i[u++] = f[n]), (i[u++] = f[n + 1]), (i[u++] = f[n + 2]);
            },
            st = function() {
                n.writeByte(33), n.writeByte(249), n.writeByte(4);
                var i, t;
                v == null ? ((i = 0), (t = 0)) : ((i = 1), (t = 2)),
                    y >= 0 && (t = y & 7),
                    (t <<= 2),
                    n.writeByte(0 | t | 0 | i),
                    u(d),
